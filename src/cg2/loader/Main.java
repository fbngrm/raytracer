...
public class Main {
	...
	public static void main(String[] args) {
		...
		glassSphere.setRefractionMediumOutside(1.000f);
		glassSphere.setRefractionMediumInside(1.005f);
		...
		scene.addShape(new Plane(glossyPlane, new Vector(0, -1, 0), new Vector(0.0f,
				1f, 0.0f)));
		scene.addShape(new Sphere(glossySphereBlue, new Vector(-1.4f, 0.5f, -5f), 1.0f));
		scene.addShape(new Sphere(glossySphereGreen, new Vector(3.5f, 0.5f, -10f), 1.0f));
		scene.addShape(new Sphere(glossySphereRed, new Vector(0.7f, 0.5f, -7f), 1.0f));
		//scene.addShape(new Sphere(glassSphereBlue, new Vector(0.7f, 0.5f, -7f), 0.1f));
		scene.addShape(new Sphere(glassSphere, new Vector(-1.2f, 0.5f, -3f), 0.7f));
		...
		scene.addLightSource(new LightSource(1.0f, new Color(1.0f, 0.0f, 0.0f),
